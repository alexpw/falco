...
class GroupByTest extends PHPUnit_Framework_TestCase {
	...
	public function recordProvider () {
		...
		$tests[] = array(
			...
			array(
				3  => array(self::$dummyRecords[0]),
				13 => array(self::$dummyRecords[1]),
				23 => array(self::$dummyRecords[2]),
				33 => array(self::$dummyRecords[3]),
				43 => array(self::$dummyRecords[4]),
				53 => array(self::$dummyRecords[5]),
			),
		...
		$tests[] = array(
			...
			array(
				3  => array(self::$dummyRecords[0]['name']),
				13 => array(self::$dummyRecords[1]['name']),
				23 => array(self::$dummyRecords[2]['name']),
				33 => array(self::$dummyRecords[3]['name']),
				43 => array(self::$dummyRecords[4]['name']),
				53 => array(self::$dummyRecords[5]['name']),
			),
		...
		$tests[] = array(
			...
			array(
				3  => array(array('name' => self::$dummyRecords[0]['name'])),
				13 => array(array('name' => self::$dummyRecords[1]['name'])),
				23 => array(array('name' => self::$dummyRecords[2]['name'])),
				33 => array(array('name' => self::$dummyRecords[3]['name'])),
				43 => array(array('name' => self::$dummyRecords[4]['name'])),
				53 => array(array('name' => self::$dummyRecords[5]['name'])),
			),
		...
		$tests[] = array(
			array('sex'), array('name','404','food'), self::$dummyRecords,
			array(
				'M' => array(
					array('name' => self::$dummyRecords[0]['name'],
						  'food' => self::$dummyRecords[0]['food']),
					array('name' => self::$dummyRecords[2]['name'],
						  'food' => self::$dummyRecords[2]['food']),
					array('name' => self::$dummyRecords[3]['name'],
						  'food' => self::$dummyRecords[3]['food']),
					array('name' => self::$dummyRecords[4]['name'],
						  'food' => self::$dummyRecords[4]['food']),
				),
				'F' => array(
					array('name' => self::$dummyRecords[1]['name'],
						  'food' => self::$dummyRecords[1]['food'],),
					array('name' => self::$dummyRecords[5]['name'],
						  'food' => self::$dummyRecords[5]['food'],),
				),
			),
